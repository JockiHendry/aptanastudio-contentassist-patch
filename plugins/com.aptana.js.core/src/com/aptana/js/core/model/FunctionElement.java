...
public class FunctionElement extends PropertyElement
{
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((_exceptions == null) ? 0 : _exceptions.hashCode());
		result = prime * result + (_isConstructor ? 1231 : 1237);
		result = prime * result + (_isMethod ? 1231 : 1237);
		result = prime * result
				+ ((_parameters == null) ? 0 : _parameters.hashCode());
		result = prime * result
				+ ((_references == null) ? 0 : _references.hashCode());
		result = prime * result
				+ ((_returnTypes == null) ? 0 : _returnTypes.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (_exceptions == null) {
			if (other._exceptions != null)
				return false;
		} else if (!_exceptions.equals(other._exceptions))
			return false;
		if (_isConstructor != other._isConstructor)
			return false;
		...
		if (_returnTypes == null) {
			if (other._returnTypes != null)
				return false;
		} else if (!_returnTypes.equals(other._returnTypes))
			return false;
		return true;
	}
