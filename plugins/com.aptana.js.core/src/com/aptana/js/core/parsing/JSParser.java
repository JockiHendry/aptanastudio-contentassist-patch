...
public class JSParser extends Parser implements IParser {
	...
	public JSParser() {
		...
		// @formatter:off
		recoveryStrategies = new ArrayList<IRecoveryStrategy>();
		...
		// Contoh: if (e.  --> if (e.identifier);
		JSInsertionRecoveryStrategy completePropertyExpression = new JSInsertionRecoveryStrategy(JSTokenType.IDENTIFIER, "", 
			JSTokenType.RPAREN, ")", JSTokenType.DOT);
		completePropertyExpression.addToken(JSTokenType.SEMICOLON, ";");
		recoveryStrategies.add(completePropertyExpression);
		
		// Contoh: for (...; e.  --> for (...; e.identifier;);
		JSInsertionRecoveryStrategy completeForExpression1 = new JSInsertionRecoveryStrategy(JSTokenType.IDENTIFIER, "", 
				JSTokenType.SEMICOLON, ";", JSTokenType.DOT);
		completeForExpression1.addToken(JSTokenType.RPAREN, ")");
		completeForExpression1.addToken(JSTokenType.SEMICOLON, ";");
		recoveryStrategies.add(completeForExpression1);
		
		// Contoh: for (e.  --> for (e.identifier;;);
		JSInsertionRecoveryStrategy completeForExpression2 = new JSInsertionRecoveryStrategy(JSTokenType.IDENTIFIER, "", 
				JSTokenType.SEMICOLON, ";", JSTokenType.DOT);
		completeForExpression2.addToken(JSTokenType.SEMICOLON, ";");
		completeForExpression2.addToken(JSTokenType.RPAREN, ")");
		completeForExpression2.addToken(JSTokenType.SEMICOLON, ";");
		recoveryStrategies.add(completeForExpression2);
